...
else
{
  ...
  {   
    case 'DB 1.9.17':
      ...
      break;
    case 'DB 1.9.16':
      $a_sql_upd_dir[] = "sql/alter_tables/1.9.17/{$db_type}/DB.1.9.17/step1/db_schema_update.sql";
      $a_sql_data_dir[] = "sql/alter_tables/1.9.17/{$db_type}/DB.1.9.17/stepZ/z_final_step.sql";
      break;
    default:
